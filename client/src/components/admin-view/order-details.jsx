...
function AdminOrdersDetails({ orderDetails }) {
                  ...
                  <Badge
                   ...
                   {`py-1 px-3 ${
                    orderDetails?.orderStatus === 'delivered' ? 'bg-green-500' :
                     orderDetails?.orderStatus === 'rejected' ? 'bg-red-800' : 'bg-black' }`}>{orderDetails?.orderStatus}</Badge>
                </div>
            </div>
            <Separator/>
    ...
    options: [
      ...
      { id: "delivered", label: "Delivered" }, // extra option
      { id: "rejected", label: "Rejected" }, // extra option
    ],
  },
                ]}
                formData={formData}
