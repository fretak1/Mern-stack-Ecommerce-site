...
function UserCartItemsContent({cartItem}) {
    ...
    const {productList} = useSelector(state => state.customerProducts)

    function handleCartItemDelete(getCartItem) {
        console.log(user?.id, getCartItem?.cartItem?.productId
)
        dispatch(deleteCartItem({userId : user?.id, productId : getCartItem?.cartItem?.productId
})).then(data=> {
